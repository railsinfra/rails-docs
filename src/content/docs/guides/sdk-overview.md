...
| --- | --- | --- |
| `rails-sdks/rails-typescript/` | Node / TypeScript | `npm install @railsinfra/rails` (v0.2.2) and `import Rails from '@railsinfra/rails'` — samples now use published npm package. |
